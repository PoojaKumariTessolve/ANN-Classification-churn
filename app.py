...
geography = st.selectbox('Geographhy', onehot_enoder_geo.categories_[0])
gender = st.selectbox('Gender', label_enoder_gender.classes_)
...
input_data = pd.DataFrame({
    ...
    'Gender':  [label_enoder_gender.transform([gender])[0]],
    'Age': [age],
    'Tenure' : [tenure],
    'Balance' : [balance],
...
geo_encoded = onehot_enoder_geo.transform([[geography]]).toarray()
